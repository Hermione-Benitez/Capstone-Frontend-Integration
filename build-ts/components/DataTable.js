...
serverSide = false, totalCount, onPageChange, onPageSizeChange, onSortChange, onSearchChange, onFilterChange, }) {
    ...
    // ── Render ─────────────────────────────────────────────────────────────────────
    return (_jsxs("div", { className: `dt-root ${densityClass} ${className}`, children: [_jsxs("div", { className: "dt-toolbar", children: [_jsxs("div", { className: "dt-toolbar-left", children: [_jsx("div", { className: "dt-search-wrap", children: _jsx(SearchBar, { id: "dt-search-input", variant: "sm", placeholder: searchPlaceholder, value: search, onChange: handleSearchChange, onClear: () => handleSearchChange("") }) }), filters.map((f) => (_jsxs("select", { className: "dt-filter-select", "aria-label": f.label, value: activeFilters[f.key] ?? "", onChange: (e) => handleFilterChange(f.key, e.target.value), children: [_jsx("option", { value: "", children: f.label }), f.options.map((opt) => (_jsx("option", { value: opt.value, children: opt.label }, opt.value)))] }, f.key))), totalActiveCount > 0 && (_jsxs("span", { className: "dt-filter-count-badge", "aria-label": `${totalActiveCount} active filter${totalActiveCount !== 1 ? 's' : ''}`, children: [_jsx("i", { className: "ti ti-filter", "aria-hidden": "true" }), totalActiveCount, " filter", totalActiveCount !== 1 ? 's' : '', _jsx("button", { className: "dt-filter-count-clear", onClick: clearAllFilters, "aria-label": "Clear all filters", title: "Clear all filters", children: _jsx("i", { className: "ti ti-x", "aria-hidden": "true" }) })] })), filters.length > 0 && (_jsxs("div", { className: "dt-preset-wrap", ref: presetPanelRef, children: [_jsx(Button, { title: "Saved filter presets", iconOnly: true, icon: "ti-bookmark", variant: "ghost", size: "sm", "aria-haspopup": "true", "aria-expanded": showPresets, onClick: () => setShowPresets((p) => !p) }), presets.length > 0 && (_jsx("span", { className: "dt-preset-count", children: presets.length })), showPresets && (_jsxs("div", { className: "dt-preset-panel", role: "dialog", "aria-label": "Filter presets", children: [_jsxs("p", { className: "dt-preset-panel-title", children: [_jsx("i", { className: "ti ti-bookmark", "aria-hidden": "true" }), " Saved Presets"] }), _jsxs("div", { className: "dt-preset-save-row", children: [_jsx("input", { type: "text", className: "dt-preset-name-input", placeholder: "Name this preset\u2026", value: presetName, onChange: (e) => setPresetName(e.target.value), onKeyDown: (e) => e.key === "Enter" && savePreset(), maxLength: 40 }), _jsx(Button, { title: "Save", icon: "ti-plus", variant: "primary", size: "sm", className: "dt-preset-save-btn", onClick: savePreset, disabled: !presetName.trim() })] }), presets.length === 0 ? (_jsx("p", { className: "dt-preset-empty", children: "No saved presets yet." })) : (_jsx("ul", { className: "dt-preset-list", children: presets.map((preset) => (_jsxs("li", { className: "dt-preset-item", children: [_jsxs("button", { className: "dt-preset-apply", onClick: () => applyPreset(preset), children: [_jsx("i", { className: "ti ti-filter", "aria-hidden": "true" }), _jsx("span", { className: "dt-preset-item-name", children: preset.name }), preset.search && (_jsx("span", { className: "dt-preset-item-meta", children: "+search" })), Object.keys(preset.filters).length > 0 && (_jsxs("span", { className: "dt-preset-item-meta", children: [Object.keys(preset.filters).length, " filter", Object.keys(preset.filters).length !== 1 ? 's' : ''] }))] }), _jsx(Button, { title: `Delete preset ${preset.name}`, iconOnly: true, icon: "ti-trash", variant: "ghost", size: "sm", className: "dt-preset-delete", onClick: (e) => deletePreset(preset.id, e) })] }, preset.id))) }))] }))] }))] }), _jsxs("div", { className: "dt-toolbar-right", children: [densityToggle && (_jsx("div", { className: "dt-density-group", role: "group", "aria-label": "Row density", children: ["compact", "regular", "relaxed"].map((d) => (_jsxs("button", { className: `dt-density-btn${density === d ? " dt-density-btn--active" : ""}`, onClick: () => setDensity(d), title: d.charAt(0).toUpperCase() + d.slice(1), "aria-pressed": density === d, children: [d === "compact" && (_jsx("i", { className: "ti ti-layout-list", "aria-hidden": "true" })), d === "regular" && (_jsx("i", { className: "ti ti-layout-rows", "aria-hidden": "true" })), d === "relaxed" && (_jsx("i", { className: "ti ti-layout-bottombar", "aria-hidden": "true" }))] }, d))) })), columnToggle && (_jsxs("div", { className: "dt-col-toggle-wrap", ref: colToggleRef, children: [_jsx(Button, { id: "dt-col-toggle-btn", title: "Column visibility", iconOnly: true, icon: "ti-columns", variant: "secondary", size: "sm", "aria-haspopup": "true", "aria-expanded": showColToggle, onClick: () => setShowColToggle((p) => !p) }), showColToggle && (_jsxs("div", { className: "dt-col-panel", role: "menu", "aria-labelledby": "dt-col-toggle-btn", children: [_jsx("p", { className: "dt-col-panel-title", children: "Show / Hide Columns" }), columns.map((col) => (_jsxs("label", { className: "dt-col-item", children: [_jsx("input", { type: "checkbox", className: "dt-checkbox", checked: !hiddenCols.has(col.key), onChange: () => setHiddenCols((prev) => {
                                                            const n = new Set(prev);
                                                            n.has(col.key) ? n.delete(col.key) : n.add(col.key);
                                                            return n;
                                                        }) }), _jsx("span", { children: col.label })] }, col.key)))] }))] })), exportable && (_jsx(Button, { id: "dt-export-btn", title: "Export", icon: "ti-download", variant: "secondary", size: "sm", onClick: handleExport })), createButtons.map((btn, i) => (_jsx(Button, { title: btn.label, icon: btn.icon, variant: btn.variant === "secondary" ? "secondary" : "primary", size: "sm", onClick: btn.onClick }, i)))] })] }), (hasActiveFilters || sortLabel) && (_jsxs("div", { className: "dt-filter-chips", "aria-label": "Active filters", children: [search && (_jsxs("span", { className: "dt-chip", children: [_jsx("i", { className: "ti ti-search", "aria-hidden": "true" }), "Search: ", _jsx("strong", { children: search }), _jsx("button", { className: "dt-chip-remove", "aria-label": "Clear search", onClick: () => handleSearchChange(""), children: _jsx("i", { className: "ti ti-x", "aria-hidden": "true" }) })] })), Object.entries(activeFilters).map(([key, val]) => {
                        if (!val)
                            return null;
                        ...
                        return (_jsxs("span", { className: "dt-chip", children: [_jsx("i", { className: "ti ti-filter", "aria-hidden": "true" }), filterDef?.label, ": ", _jsx("strong", { children: optLabel }), _jsx("button", { className: "dt-chip-remove", "aria-label": `Remove ${filterDef?.label} filter`, onClick: () => removeFilter(key), children: _jsx("i", { className: "ti ti-x", "aria-hidden": "true" }) })] }, key));
                                    ...
                                    onSortChange?.(null, null);
                                }, children: _jsx("i", { className: "ti ti-x", "aria-hidden": "true" }) })] })), (hasActiveFilters) && (_jsx(Button, { title: "Clear all", icon: "ti-refresh", variant: "ghost", size: "sm", className: "dt-chip-clear-all", onClick: clearAllFilters }))] })), hasNoResults && (_jsxs("div", { className: "dt-no-results-banner", role: "status", "aria-live": "polite", children: [_jsxs("div", { className: "dt-no-results-left", children: [_jsx("i", { className: "ti ti-search-off dt-no-results-icon", "aria-hidden": "true" }), _jsxs("span", { className: "dt-no-results-text", children: ["No results for", " ", search && _jsxs("strong", { children: ["\u201C", search, "\u201D"] }), search && activeFilterCount > 0 && " with ", activeFilterCount > 0 && (_jsxs("strong", { children: [activeFilterCount, " active filter", activeFilterCount !== 1 ? "s" : ""] }))] })] }), _jsx(Button, { title: "Clear filters", icon: "ti-x", variant: "ghost", size: "sm", className: "dt-no-results-clear", onClick: clearAllFilters, "aria-label": "Clear all filters and search" })] })), selectable && selectedCount > 0 && (_jsxs("div", { className: "dt-bulk-bar", role: "toolbar", "aria-label": "Bulk actions", children: [_jsxs("div", { className: "dt-bulk-bar-left", children: [_jsxs("span", { className: "dt-bulk-count", children: [_jsx("i", { className: "ti ti-checkbox", "aria-hidden": "true" }), _jsx("strong", { children: selectedCount }), " row", selectedCount !== 1 ? "s" : "", " ", "selected"] }), !selectAllMatching && allMatchingKeys.length > pageSize && (_jsxs("button", { className: "dt-bulk-select-all", onClick: selectAll, children: ["Select all ", _jsx("strong", { children: allMatchingKeys.length }), " matching results"] })), selectAllMatching && (_jsxs("span", { className: "dt-bulk-all-badge", children: [_jsx("i", { className: "ti ti-check", "aria-hidden": "true" }), "All ", allMatchingKeys.length, " results selected"] }))] }), _jsxs("div", { className: "dt-bulk-actions", children: [bulkActions.map((action, i) => (_jsx(Button, { title: action.label, icon: action.icon, variant: action.variant === "danger" ? "danger" : "secondary", size: "sm", onClick: () => handleBulkAction(action) }, i))), _jsx(Button, { title: "Deselect", icon: "ti-x", variant: "ghost", size: "sm", onClick: clearSelection, "aria-label": "Clear selection" })] })] })), _jsx("div", { className: "dt-table-wrap", ref: tableWrapRef, children: _jsxs("table", { className: "dt-table", "aria-label": "Data table", children: [_jsx("thead", { children: _jsxs("tr", { children: [selectable && (_jsx("th", { className: "dt-th dt-th--check dt-th--sticky-left", children: _jsx("input", { type: "checkbox", className: "dt-checkbox", checked: allPageSelected, ref: (el) => {
                                                if (el)
                                        ...
                                        return (_jsxs("th", { className: [
                                            ...
                                            }, onClick: col.sortable ? () => handleSort(col.key) : undefined, onKeyDown: col.sortable
                                                ? (e) => {
                                                ...
                                                : undefined, tabIndex: col.sortable ? 0 : undefined, "aria-sort": col.sortable
                                                ? sortKey === col.key
                                                    ? sortDir === "asc"
                                                        ? "ascending"
                                                        : "descending"
                                                ...
                                                width: `${55 + ((i * 17 + col.key.length * 7) % 35)}%`,
                                                    ...
                                                    : "Create a new record to get started." }), hasActiveFilters && (_jsx(Button, { title: "Clear Filters", icon: "ti-refresh", variant: "secondary", size: "sm", className: "dt-empty-action", onClick: clearAllFilters }))] }) }) })) : (_jsxs(_Fragment, { children: [totalHeight !== null && offsetY > 0 && (_jsx("tr", { "aria-hidden": "true", style: { height: offsetY }, children: _jsx("td", { colSpan: totalCols, style: { padding: 0, border: 0 } }) })), virtualRows.map((row) => {
